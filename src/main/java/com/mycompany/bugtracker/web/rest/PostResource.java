...
import com.mycompany.bugtracker.domain.Post;
import com.mycompany.bugtracker.repository.PostRepository;
...
/**
 * REST controller for managing {@link com.mycompany.bugtracker.domain.Post}.
 */
@RestController
@RequestMapping("/api")
@Transactional
